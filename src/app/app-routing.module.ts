...
const routes: Routes = [
  ...
  {path: 'editProgram/:id', component: EditProgramComponent, canActivate:[AuthGuard]},
  {path: 'programDetails/:pID', component: ProgramDetailsComponent, canActivate:[AuthGuard] },
